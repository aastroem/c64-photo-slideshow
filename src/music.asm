...
; bass: pumping root octaves, eighth notes
seq0    !byte 31,12, 43,12, 31,12, 43,12, 31,12, 43,12, 31,12, 43,12  ; Gm
        ...
        !byte 29,12, 41,12, 29,12, 41,12, 29,12, 41,12, 29,12, 41,12  ; F
        !byte $ff

; pluck hook: root-fifth-octave rolls per chord, eighth notes
seq1    !byte 43,12, 50,12, 55,12, 50,12, 46,12, 50,12, 55,12, 50,12  ; Gm
...
; topline: 8-bar anthem (loops every 2 chord rounds)
seq2    !byte 62,48, 58,24, 60,24                                     ; Gm
        !byte 58,48, 55,24, 58,24                                     ; Eb
        !byte 62,48, 65,24, 62,24                                     ; Bb
        !byte 60,48, 57,24, 60,24                                     ; F
        !byte 55,48, 57,24, 58,24                                     ; Gm
        !byte 58,72, 55,24                                            ; Eb
